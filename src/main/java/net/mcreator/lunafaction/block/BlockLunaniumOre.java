...
public class BlockLunaniumOre extends ElementsLunafaction.ModElement {
	@GameRegistry.ObjectHolder("lunafaction:lunaniumore")
	public static final Block block = null;
	public BlockLunaniumOre(ElementsLunafaction instance) {
		super(instance, 1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lunaniumore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lunafaction:lunaniumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("lunaniumore");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemLunaniumGem.block, (int) (1)));
		}
	}
}
