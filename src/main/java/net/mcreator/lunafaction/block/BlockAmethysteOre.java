...
public class BlockAmethysteOre extends ElementsLunafaction.ModElement {
	@GameRegistry.ObjectHolder("lunafaction:amethysteore")
	public static final Block block = null;
	public BlockAmethysteOre(ElementsLunafaction instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lunafaction:amethysteore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemAmethysteGem.block, (int) (1)));
		}
	}
}
