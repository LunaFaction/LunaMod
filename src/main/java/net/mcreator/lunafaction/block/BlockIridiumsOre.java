...
public class BlockIridiumsOre extends ElementsLunafaction.ModElement {
	@GameRegistry.ObjectHolder("lunafaction:iridiumsore")
	public static final Block block = null;
	public BlockIridiumsOre(ElementsLunafaction instance) {
		super(instance, 48);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("iridiumsore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lunafaction:iridiumsore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("iridiumsore");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemIridiumsGem.block, (int) (1)));
		}
	}
}
