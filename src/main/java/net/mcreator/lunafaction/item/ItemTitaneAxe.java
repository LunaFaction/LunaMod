...
public class ItemTitaneAxe extends ElementsLunafaction.ModElement {
	@GameRegistry.ObjectHolder("lunafaction:titaneaxe")
	public static final Item block = null;
	public ItemTitaneAxe(ElementsLunafaction instance) {
		super(instance, 89);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("titaneaxe").setRegistryName("titaneaxe").setCreativeTab(TabLunaFaction.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lunafaction:titaneaxe", "inventory"));
	}
